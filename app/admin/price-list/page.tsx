        ...
        <div className="p-6 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-1 mb-6 border-b border-gray-200">
            ...
            <button
              ...
              className="px-3 py-2 text-sm font-medium text-primary hover:bg-primary/5 rounded-lg transition-colors whitespace-nowrap flex items-center gap-1.5"
            >
          ...
          <CsvImportModal
            ...
            onComplete={() => { fetchCategories(); fetchItems() }}
          />
