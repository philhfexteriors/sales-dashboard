  ...
  return (
    <AppShell>
      <div className="p-6 max-w-2xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">New Production Plan</h1>
        <p className="text-gray-500 mb-8">
          Start a new production plan. You&apos;ll be guided through client info, section selection, and all the details.
        </p>
