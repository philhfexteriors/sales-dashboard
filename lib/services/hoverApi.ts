...
export const HOVER_API_BASE = process.env.HOVER_API_BASE_URL || 'https://hover.to/api/v3'
...
/**
 * Check if Hover is connected (tokens exist and are valid).
 */
...
/**
 * Check if Hover credentials are configured in environment.
 */
export function isHoverConfigured(): boolean {
